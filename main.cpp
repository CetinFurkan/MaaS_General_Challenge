...
void convexHull(Point points[], int n); //simple decleration for testing
...
float ymin = points[0].y;  //PROPER CHANGE FOR SUPPORTING FLOATS 
int min = 0;               //PROPER CHANGE FOR SUPPORTING FLOATS 
for (int i = 1; i < n; i++)
{
	float y = points[i].y; //PROPER CHANGE FOR SUPPORTING FLOATS 
